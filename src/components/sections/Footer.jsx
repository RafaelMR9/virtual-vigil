...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-700 px-10 pt-6 md:pt-10 pb-3 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-10 mb-6">
        ...
        <div className='mx-0 md:mx-auto'>
          <p className='font-medium text-lg mb-2 md:mb-5'>Links</p>
          <nav className="font-bold flex flex-row md:flex-col gap-3">
        ...
        <div>
          <p className='font-medium text-lg mb-2 md:mb-5'>Endereço</p>
          <div className="font-bold flex flex-row flex-wrap md:flex-col gap-1">
        ...
        <div>
          <p className='font-medium text-lg mb-2 md:mb-5'>Jornal</p>
          <div className="flex flex-col gap-6 md:gap-8">
            <form className="flex flex-col gap-3 max-w-[20rem]" onSubmit={handleFormSubmit}>
      ...
      <hr className='mb-4'/>
      <div className="font-semibold flex flex-col jusitify-center items-center text-center gap-1">
