  ...
  return ( 
    <section id="home" className="min-h-screen flex flex-col justify-center align-center text-center px-8 md:px-20 lg:px-32 pt-16 relative overflow-hidden">
      ...
      <header>
        ...
        <div className="bg-slate-800 inline-flex gap-2 items-center rounded-lg px-5 py-2 mt-10 md:mt-16"><FaCartShopping /> Mais de 20 milhões de clientes satisfeitos</div>
