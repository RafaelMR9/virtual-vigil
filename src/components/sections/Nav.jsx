...
export default function Nav() {
  ...
  return (
    <nav className="animate-fadedown flex rounded-lg items-center justify-between flex-wrap bg-slate-800 shadow-nav fixed top-0 left-0 right-0 z-[999] px-8 py-4 mt-4 mx-10">
      <Link 
        href="#home"
      ...
      <div className={`w-full ${isMenuOpen ? 'block' : 'hidden'} flex-grow lg:flex lg:items-center lg:w-auto`}>
